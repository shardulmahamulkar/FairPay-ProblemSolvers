          ...
          <div className="flex-1 flex flex-col gap-3">
            ...
            <div className="bg-white/60 dark:bg-white/10 backdrop-blur-xl rounded-[20px] p-3 flex items-center gap-3 border border-white/60 dark:border-white/10 shadow-sm">
              ...
              <div className="flex flex-col">
                <span className="text-[#64748B] dark:text-slate-300 text-[12px] font-medium leading-none mb-1.5">To Pay</span>
                <AnimatedCounter value={summary.totalOwed} prefix={getCurrencySymbol()} className="text-[#0F172A] dark:text-white text-[16px] font-bold leading-none" />
              </div>
            </div>
            ...
            <div className="bg-white/60 dark:bg-white/10 backdrop-blur-xl rounded-[20px] p-3 flex items-center gap-3 border border-white/60 dark:border-white/10 shadow-sm">
              ...
              <div className="flex flex-col">
                <span className="text-[#64748B] dark:text-slate-300 text-[12px] font-medium leading-none mb-1.5">To Receive</span>
                <AnimatedCounter value={summary.totalReceivable} prefix={getCurrencySymbol()} className="text-[#0F172A] dark:text-white text-[16px] font-bold leading-none" />
              </div>
            </div>
          </div>
        </div>
